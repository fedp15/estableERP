 ...
 * @author RaaG
 */
public class DatosReportBalaceGeneral{
    private String cta, ctaNOmbre, ctaNivel1, ctaNivel2, ctaNivel3, ctaNivel4, 
                   ...
                   ctaNombreNivel8, tituloReporte;
    private int ctaNivel;
    private Double total, totalActivos, totalPasivoCapital, totalEgresoIngresos;

    public DatosReportBalaceGeneral()
    {
    }
    ...
    public void DatosReportVentas(int ctaNivel, String cta, String ctaNOmbre, String ctaNivel1, 
                                  ...
                                  String ctaNombreNivel8, String tituloReporte, Double totalActivos, 
                                  Double totalPasivoCapital, Double totalEgresoIngresos){
