...
public class DatasourceReportBalanceComprobacion implements JRDataSource
{
    private List<DatosReportBalaceComprobacion> listaParticipantes = new ArrayList<DatosReportBalaceComprobacion>();
    ...
    public void addRegistros(DatosReportBalaceComprobacion participante)
    {
