 ...
 * @author RaaG
 */
public class DatosReportMayorAnalico{
    private String cta, ctaNOmbre, ctaNivel1, ctaNivel2, ctaNivel3, ctaNivel4, 
                   ...
                   ctaNombreNivel8;
    private String comprobante, fecha, doc, descrip;
    private int ctaNivel;
    private double saldoInicial, totalDebe, totalHaber, total, debeDetalle, saldoInicialDet,
                   haberDetelle, saldoFinalDet, totalActivos, totalPasivoCapital, totalEgresoIngresos;

    public DatosReportMayorAnalico()
    {
    }
    
    public void DatosReportMayorAnalico(int ctaNivel, String cta, String ctaNOmbre, String ctaNivel1, 
                                        ...
                                        Double totalHaber, String comprobante, String fecha, String doc, String descrip, Double saldoInicialDet,
                                        Double debeDetalle, Double haberDetelle, Double saldoFinalDet, Double totalActivos, Double totalPasivoCapital,
        ...
        this.saldoInicialDet      = saldoInicialDet;
        this.debeDetalle          = debeDetalle;
        this.haberDetelle         = haberDetelle;
        this.saldoFinalDet        = saldoFinalDet;
...
//******************************DETALLE**************************************
    ...
    public double getSaldoInicialDet() {
        return saldoInicialDet;
    }

    public void setSaldoInicialDet(double saldoInicialDet) {
        this.saldoInicialDet = saldoInicialDet;
    }

    public double getDebeDetalle() {
        return debeDetalle;
    }

    public void setDebeDetalle(double debeDetalle) {
        this.debeDetalle = debeDetalle;
    }

    public double getHaberDetelle() {
        return haberDetelle;
    }

    public void setHaberDetelle(double haberDetelle) {
        this.haberDetelle = haberDetelle;
    }

    public double getSaldoFinalDet() {
        return saldoFinalDet;
    }

    public void setSaldoFinalDet(double saldoFinalDet) {
        this.saldoFinalDet = saldoFinalDet;
    }
