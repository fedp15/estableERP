...
public class SpFormCategoriasVehiculos extends conexion{
    private static SpFormCategoriasVehiculos spFormCategoriasVehiculos;
    ...
    private SpFormCategoriasVehiculos() {
    }
    
    public static SpFormCategoriasVehiculos getFormCategoriasVehiculos(){
        if (spFormCategoriasVehiculos == null){
            spFormCategoriasVehiculos = new SpFormCategoriasVehiculos();
        }

        return spFormCategoriasVehiculos;
    }
    
    public ResultSet callStoreProcedureCategVehiculos(String op, String op2, String codigo, String nombre, int activo){
        String sql = "{call sp_formCategoriasVehiculos(?,?,?,?,?,?,?,?)}";
...
//                }
            ...
            Logger.getLogger(SpFormCategoriasVehiculos.class.getName()).log(Level.SEVERE, null, ex);
        }
