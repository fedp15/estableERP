 ...
 * @author Ricardo
 */
public class sp_mayor_analitico extends conexion{
    ...
    public sp_mayor_analitico() {

    }
    
    public ResultSet getMayorAnalitico(String codEmpresa, int activo, String fechaDesde, String fechaHasta){
        try {
            creaConexion();
    
            query = "CALL `sp_mayor_analico`('"+codEmpresa+"', "+activo+", '"+fechaDesde+"', '"+fechaHasta+"')";
...
//                          stmt.setInt(7, activo);
            ...
            Logger.getLogger(sp_mayor_analitico.class.getName()).log(Level.SEVERE, null, ex);
        }
