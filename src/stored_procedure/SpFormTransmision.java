...
public class SpFormTransmision extends conexion{
    private static SpFormTransmision spFormTransmision;
    private CallableStatement cs = null;
    private ResultSet rsFormTransmision;
    ...
    private SpFormTransmision() {
    }
    
    public static SpFormTransmision getFormTransmision(){
        if (spFormTransmision == null){
            spFormTransmision = new SpFormTransmision();
        }

        return spFormTransmision;
    }
    
    public ResultSet callStoreProcedureTransmision(String op, String op2, String codigo, String nombre, int activo){
        String sql = "{call sp_formTransmision(?,?,?,?,?,?,?,?)}";
        ...
        try{
            ...
            if(op.equals("SELECT")){
                ...
                rsFormTransmision = consultarStoreProcedure(cs);
            }
...
//                }
            ...
            Logger.getLogger(SpFormTransmision.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        return rsFormTransmision;
    }
}