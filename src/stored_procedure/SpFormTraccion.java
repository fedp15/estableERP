...
public class SpFormTraccion extends conexion{
    private static SpFormTraccion spFormTraccion;
    ...
    private SpFormTraccion() {
    }
    
    public static SpFormTraccion getFormTraccion(){
        if (spFormTraccion == null){
            spFormTraccion = new SpFormTraccion();
        }

        return spFormTraccion;
    }
    
    public ResultSet callStoreProcedureTraccion(String op, String op2, String codigo, String nombre, int activo){
        String sql = "{call sp_formTraccion(?,?,?,?,?,?,?,?)}";
...
//                }
            ...
            Logger.getLogger(SpFormTraccion.class.getName()).log(Level.SEVERE, null, ex);
        }
